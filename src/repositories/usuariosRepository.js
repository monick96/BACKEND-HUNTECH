...
const updateDesarrolladorTransaccional = async (email, usuario) => {
  ...
  try {
    ...
    let values = [];
    let paramIndex = 1;
    const { nombre, apellido, descripcion, skills, perfil_it, fecha_nacimiento, esta_validado, validado_por_usuario_id, genero, telefono, puesto_actual, is_disponible, is_deleted} = usuario;
